...
// compile time. The source of truth lives at skills/squiz/SKILL.md; we keep
// a literal copy at cmd/squiz/skill.md because //go:embed cannot reach above
// the package directory. A sync-check test (skill_test.go) asserts the two
// files stay byte-identical; if it fails, run:
//
...
// Usage:
//
//	squiz skill              # write SKILL.md to stdout
//	squiz skill --out PATH   # write SKILL.md to PATH
//
