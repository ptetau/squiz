...
// cmdCatalog implements `squiz-plan catalog [name] [--json] [--previews]`.
//
// Same shape as `squiz catalog` — squiz-plan agents author specs that
// reference the same wf/arch libraries, so they read the same catalog.
//
//	squiz-plan catalog                  # list catalog names
//	squiz-plan catalog wf               # text listing
//	squiz-plan catalog wf --json        # JSON array
//	squiz-plan catalog wf --previews    # write gallery HTML
//	squiz-plan catalog arch             # same shape
//	squiz-plan catalog dsl              # primitives + grammar
//	squiz-plan catalog themes           # 8 themes + vibe lines
